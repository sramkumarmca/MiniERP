...
(function () {
    ...
    var stateSettings = {
        ...
        state: {
            ...
            controller: 'MainOffersController as vm'
        },
        title: {
            textTranslationId: 'main.offers.title'
        },
        breadcrumb: {
            titleTranslationId: 'main.offers.breadcrumb'
        },
        sidebarKey: 'main.offers',
        translations: 'app/main/offers'
    };
